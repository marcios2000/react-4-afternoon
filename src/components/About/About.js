    ...
    return (
      <div>
        <div className='subnav'>
          <Link to="/about" className="subnav_links"><div>About</div></Link>
          <Link to="/about/history" className="subnav_links"><div>History</div></Link>
          <Link to="/about/contact" className="subnav_links"><div>Contact</div></Link>
        </div>
        <div className='box'>
        <Switch>
